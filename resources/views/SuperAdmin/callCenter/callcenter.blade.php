...
@endsection
@section('page_header')
    Rescue Center <button type="button" class="btn bg-purple" data-toggle="modal" data-target="#callCenterModal"><i class="fa fa-plus"></i> Add New</button>
@endsection
...
@section('variable_menu')
    ...
    <li class="active"><a href="{{url('/super-admin/rescueCenter')}}"><i class="fa fa-phone-square"></i> <span>Rescue Centers</span></a></li>
            ...
            <form method="post" id="add-call-center">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Add Rescue Center</h4>
                    </div>

                    <div class="modal-body">
                        @csrf
                        <div class="form-group">
                            <label for="callcenter">Rescue Center Name</label>
